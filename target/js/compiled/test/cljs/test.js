...
return cljs.core.assoc.call(null,G__44645,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__44645;
}
});
...
var len__10205__auto___44650 = arguments.length;
var i__10206__auto___44651 = (0);
while(true){
if((i__10206__auto___44651 < len__10205__auto___44650)){
args__10212__auto__.push((arguments[i__10206__auto___44651]));

var G__44652 = (i__10206__auto___44651 + (1));
i__10206__auto___44651 = G__44652;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq44647){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__44648,G__44649,seq44647__$2);
});
...
var file = cljs.core.get.call(null,map__44654__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__44654__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__44654__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__44654,map__44654__$1,file,line,column){
return (function (p1__44653_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__44653_SHARP_));
});})(map__44654,map__44654__$1,file,line,column))
...
var temp__5457__auto___44656 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___44656)){
var message_44657 = temp__5457__auto___44656;
cljs.core.println.call(null,message_44657);
} else {
}
...
var temp__5457__auto___44658 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___44658)){
var message_44659 = temp__5457__auto___44658;
cljs.core.println.call(null,message_44659);
} else {
}
...
var output_dir = "target/js/compiled/test";
var output_dir__$1 = (function (){var G__44660 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44660),"/"].join('');
} else {
return G__44660;
}
})();
...
var G__44662 = exception.stack;
var G__44662__$1 = (((G__44662 == null))?null:clojure.string.split_lines.call(null,G__44662));
var G__44662__$2 = (((G__44662__$1 == null))?null:cljs.core.get.call(null,G__44662__$1,depth));
if((G__44662__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__44662__$2);
}
} else {
...
var vec__44663 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__44663,(0),null);
var column = cljs.core.nth.call(null,vec__44663,(1),null);
var vec__44666 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__44666,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__44666,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__44666,(2),null);
...
var m__$1 = (function (){var G__44669 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__44669__$1 = (((G__44669 instanceof cljs.core.Keyword))?G__44669.fqn:null);
switch (G__44669__$1) {
case "fail":
...
var G__44673 = (function (){var G__44672 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__44672);
} else {
return G__44672;
}
})();
...
return cljs.core.vary_meta.call(null,G__44674,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__44678 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__44678,(0),null);
var types = vec__44678;
...
return cljs.core.map.call(null,(function (p__44681){
var vec__44682 = p__44681;
var ns = cljs.core.nth.call(null,vec__44682,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__44682,(1),null);
return ((function (vec__44682,ns,vars__$1){
return (function (){
...
var G__44685 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1){
return (function (){
var seq__44686 = cljs.core.seq.call(null,vars__$1);
var chunk__44687 = null;
var count__44688 = (0);
var i__44689 = (0);
while(true){
if((i__44689 < count__44688)){
var v = cljs.core._nth.call(null,chunk__44687,i__44689);
var temp__5457__auto___44691 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___44691)){
var t_44692 = temp__5457__auto___44691;
each_fixture_fn.call(null,((function (seq__44686,chunk__44687,count__44688,i__44689,t_44692,temp__5457__auto___44691,v,each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_44692)));
});})(seq__44686,chunk__44687,count__44688,i__44689,t_44692,temp__5457__auto___44691,v,each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1))
);
} else {
}

var G__44693 = seq__44686;
var G__44694 = chunk__44687;
var G__44695 = count__44688;
var G__44696 = (i__44689 + (1));
seq__44686 = G__44693;
chunk__44687 = G__44694;
count__44688 = G__44695;
i__44689 = G__44696;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__44686);
if(temp__5457__auto__){
var seq__44686__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__44686__$1)){
var c__9857__auto__ = cljs.core.chunk_first.call(null,seq__44686__$1);
var G__44697 = cljs.core.chunk_rest.call(null,seq__44686__$1);
var G__44698 = c__9857__auto__;
var G__44699 = cljs.core.count.call(null,c__9857__auto__);
var G__44700 = (0);
seq__44686 = G__44697;
chunk__44687 = G__44698;
count__44688 = G__44699;
i__44689 = G__44700;
continue;
} else {
var v = cljs.core.first.call(null,seq__44686__$1);
var temp__5457__auto___44701__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___44701__$1)){
var t_44702 = temp__5457__auto___44701__$1;
each_fixture_fn.call(null,((function (seq__44686,chunk__44687,count__44688,i__44689,t_44702,temp__5457__auto___44701__$1,v,seq__44686__$1,temp__5457__auto__,each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_44702)));
});})(seq__44686,chunk__44687,count__44688,i__44689,t_44702,temp__5457__auto___44701__$1,v,seq__44686__$1,temp__5457__auto__,each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1))
);
} else {
}

var G__44703 = cljs.core.next.call(null,seq__44686__$1);
var G__44704 = null;
var G__44705 = (0);
var G__44706 = (0);
seq__44686 = G__44703;
chunk__44687 = G__44704;
count__44688 = G__44705;
i__44689 = G__44706;
continue;
}
} else {
...
});})(each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1))
);
});})(each_fixture_fn,G__44685,G__44685__$1,env,once_fixtures,each_fixtures,vec__44682,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44685__$1)].join('')));

}
})());
});
;})(vec__44682,ns,vars__$1))
