...
var or__41412__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj53278 = {"detail":data};
return obj53278;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41400__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41400__auto__)){
var and__41400__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__53285 = cljs.core._EQ_;
var expr__53286 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__53285.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__53286))){
return ((function (pred__53285,expr__53286){
return (function (p1__53279_SHARP_){
return console.warn(p1__53279_SHARP_);
});
;})(pred__53285,expr__53286))
} else {
if(cljs.core.truth_(pred__53285.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__53286))){
return ((function (pred__53285,expr__53286){
return (function (p1__53280_SHARP_){
return console.debug(p1__53280_SHARP_);
});
;})(pred__53285,expr__53286))
} else {
if(cljs.core.truth_(pred__53285.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__53286))){
return ((function (pred__53285,expr__53286){
return (function (p1__53281_SHARP_){
return console.error(p1__53281_SHARP_);
});
;})(pred__53285,expr__53286))
} else {
return ((function (pred__53285,expr__53286){
return (function (p1__53282_SHARP_){
return console.log(p1__53282_SHARP_);
});
;})(pred__53285,expr__53286))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__53289){
...
var opts = map__53290__$1;
var eval_fn = cljs.core.get.call(null,map__53290__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__53292_SHARP_){
return new_def.callback(p1__53292_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__53294,(0),null);
var v = cljs.core.nth.call(null,vec__53294,(1),null);
...
if(cljs.core.truth_((function (){var and__41400__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1516433048986
