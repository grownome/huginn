...
var G__38365 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__38365,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__38365;
}
});
...
var or__8926__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__10205__auto___38370 = arguments.length;
var i__10206__auto___38371 = (0);
while(true){
if((i__10206__auto___38371 < len__10205__auto___38370)){
args__10212__auto__.push((arguments[i__10206__auto___38371]));

var G__38372 = (i__10206__auto___38371 + (1));
i__10206__auto___38371 = G__38372;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__10213__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38367){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38368,G__38369,seq38367__$2);
});
...
var file = cljs.core.get.call(null,map__38374__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38374__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38374__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__38374,map__38374__$1,file,line,column){
return (function (p1__38373_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__38373_SHARP_));
});})(map__38374,map__38374__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9981__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9981__auto__,prefer_table__9982__auto__,method_cache__9983__auto__,cached_hierarchy__9984__auto__,hierarchy__9985__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8926__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
...
var temp__5457__auto___38376 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___38376)){
var message_38377 = temp__5457__auto___38376;
cljs.core.println.call(null,message_38377);
} else {
}
...
var temp__5457__auto___38378 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___38378)){
var message_38379 = temp__5457__auto___38378;
cljs.core.println.call(null,message_38379);
} else {
}
...
var output_dir__$1 = (function (){var G__38380 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38380),"/"].join('');
} else {
return G__38380;
}
})();
...
var temp__5455__auto__ = (function (){var and__8914__auto__ = typeof exception.stack === 'string';
if(and__8914__auto__){
var G__38382 = exception.stack;
var G__38382__$1 = (((G__38382 == null))?null:clojure.string.split_lines.call(null,G__38382));
var G__38382__$2 = (((G__38382__$1 == null))?null:cljs.core.get.call(null,G__38382__$1,depth));
if((G__38382__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__38382__$2);
}
} else {
...
var vec__38383 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__38383,(0),null);
var column = cljs.core.nth.call(null,vec__38383,(1),null);
var vec__38386 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__38386,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__38386,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__38386,(2),null);
...
var m__$1 = (function (){var G__38389 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38393 = (function (){var G__38392 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__38392);
} else {
return G__38392;
}
})();
...
return cljs.core.vary_meta.call(null,G__38394,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__38398 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__38398,(0),null);
var types = vec__38398;
...
var ns = cljs.core.nth.call(null,vec__38402,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__38402,(1),null);
return ((function (vec__38402,ns,vars__$1){
return (function (){
...
var G__38405 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1){
return (function (){
var seq__38406 = cljs.core.seq.call(null,vars__$1);
var chunk__38407 = null;
var count__38408 = (0);
var i__38409 = (0);
while(true){
if((i__38409 < count__38408)){
var v = cljs.core._nth.call(null,chunk__38407,i__38409);
var temp__5457__auto___38411 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___38411)){
var t_38412 = temp__5457__auto___38411;
each_fixture_fn.call(null,((function (seq__38406,chunk__38407,count__38408,i__38409,t_38412,temp__5457__auto___38411,v,each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38412)));
});})(seq__38406,chunk__38407,count__38408,i__38409,t_38412,temp__5457__auto___38411,v,each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1))
);
} else {
}

var G__38413 = seq__38406;
var G__38414 = chunk__38407;
var G__38415 = count__38408;
var G__38416 = (i__38409 + (1));
seq__38406 = G__38413;
chunk__38407 = G__38414;
count__38408 = G__38415;
i__38409 = G__38416;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__38406);
if(temp__5457__auto__){
var seq__38406__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38406__$1)){
var c__9857__auto__ = cljs.core.chunk_first.call(null,seq__38406__$1);
var G__38417 = cljs.core.chunk_rest.call(null,seq__38406__$1);
var G__38418 = c__9857__auto__;
var G__38419 = cljs.core.count.call(null,c__9857__auto__);
var G__38420 = (0);
seq__38406 = G__38417;
chunk__38407 = G__38418;
count__38408 = G__38419;
i__38409 = G__38420;
continue;
} else {
var v = cljs.core.first.call(null,seq__38406__$1);
var temp__5457__auto___38421__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___38421__$1)){
var t_38422 = temp__5457__auto___38421__$1;
each_fixture_fn.call(null,((function (seq__38406,chunk__38407,count__38408,i__38409,t_38422,temp__5457__auto___38421__$1,v,seq__38406__$1,temp__5457__auto__,each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38422)));
});})(seq__38406,chunk__38407,count__38408,i__38409,t_38422,temp__5457__auto___38421__$1,v,seq__38406__$1,temp__5457__auto__,each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1))
);
} else {
}

var G__38423 = cljs.core.next.call(null,seq__38406__$1);
var G__38424 = null;
var G__38425 = (0);
var G__38426 = (0);
seq__38406 = G__38423;
chunk__38407 = G__38424;
count__38408 = G__38425;
i__38409 = G__38426;
continue;
}
} else {
...
});})(each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1))
);
});})(each_fixture_fn,G__38405,G__38405__$1,env,once_fixtures,each_fixtures,vec__38402,ns,vars__$1))
], null);
