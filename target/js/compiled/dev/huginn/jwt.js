 ...
 */
huginn.jwt.create_jwt = (function huginn$jwt$create_jwt(p__44545){
var map__44546 = p__44545;
var map__44546__$1 = ((((!((map__44546 == null)))?((((map__44546.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44546.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44546):map__44546);
var opts = map__44546__$1;
var projectId = cljs.core.get.call(null,map__44546__$1,new cljs.core.Keyword(null,"projectId","projectId",-1551013096));
var tokenExpMins = cljs.core.get.call(null,map__44546__$1,new cljs.core.Keyword(null,"tokenExpMins","tokenExpMins",-1638711857));
var privateKey = cljs.core.get.call(null,map__44546__$1,new cljs.core.Keyword(null,"privateKey","privateKey",1845961641));
var privateKeyFile = cljs.core.get.call(null,map__44546__$1,new cljs.core.Keyword(null,"privateKeyFile","privateKeyFile",2040006267));
var algorithm = cljs.core.get.call(null,map__44546__$1,new cljs.core.Keyword(null,"algorithm","algorithm",739262820));
...
huginn.jwt.client_id = (function huginn$jwt$client_id(p__44548){
...
var opts = map__44549__$1;
var projectId = cljs.core.get.call(null,map__44549__$1,new cljs.core.Keyword(null,"projectId","projectId",-1551013096));
var registryId = cljs.core.get.call(null,map__44549__$1,new cljs.core.Keyword(null,"registryId","registryId",-1767694006));
var cloudRegion = cljs.core.get.call(null,map__44549__$1,new cljs.core.Keyword(null,"cloudRegion","cloudRegion",-857757214));
var deviceId = cljs.core.get.call(null,map__44549__$1,new cljs.core.Keyword(null,"deviceId","deviceId",1909987208));
 ...
 *   are connecting too
 */
huginn.jwt.connection_args = (function huginn$jwt$connection_args(p__44551){
...
var opts = map__44552__$1;
var mqttBridgeHostname = cljs.core.get.call(null,map__44552__$1,new cljs.core.Keyword(null,"mqttBridgeHostname","mqttBridgeHostname",1814277029));
var mqttBridgePort = cljs.core.get.call(null,map__44552__$1,new cljs.core.Keyword(null,"mqttBridgePort","mqttBridgePort",1181584124));
var projectId = cljs.core.get.call(null,map__44552__$1,new cljs.core.Keyword(null,"projectId","projectId",-1551013096));
var privateKeyFile = cljs.core.get.call(null,map__44552__$1,new cljs.core.Keyword(null,"privateKeyFile","privateKeyFile",2040006267));
var algorithm = cljs.core.get.call(null,map__44552__$1,new cljs.core.Keyword(null,"algorithm","algorithm",739262820));
