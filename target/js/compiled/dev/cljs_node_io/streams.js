...
var x39348 = streamobj;
x39348.cljs_node_io$protocols$IInputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39348.cljs_node_io$protocols$IOFactory$ = cljs.core.PROTOCOL_SENTINEL;

x39348.cljs_node_io$protocols$IOFactory$make_reader$arity$2 = ((function (x39348){
...
x39348.cljs_node_io$protocols$IOFactory$make_input_stream$arity$2 = ((function (x39348){
...
x39348.cljs_node_io$protocols$IOFactory$make_writer$arity$2 = ((function (x39348){
return (function (this$,_){
var this$__$1 = this;
...
x39348.cljs_node_io$protocols$IOFactory$make_output_stream$arity$2 = ((function (x39348){
return (function (this$,_){
var this$__$1 = this;
throw (new Error(["ILLEGAL ARGUMENT: Cannot open <",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,this$__$1)),"> as an OutputStream."].join('')));
});})(x39348))
...
var x39349 = streamobj;
x39349.cljs_node_io$protocols$IOutputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39349.cljs_node_io$protocols$IOFactory$ = cljs.core.PROTOCOL_SENTINEL;

x39349.cljs_node_io$protocols$IOFactory$make_reader$arity$2 = ((function (x39349){
return (function (this$,_){
var this$__$1 = this;
...
x39349.cljs_node_io$protocols$IOFactory$make_input_stream$arity$2 = ((function (x39349){
return (function (this$,_){
var this$__$1 = this;
throw (new Error(["ILLEGAL ARGUMENT: Cannot open <",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,this$__$1)),"> as an InputStream."].join('')));
});})(x39349))
...
x39349.cljs_node_io$protocols$IOFactory$make_writer$arity$2 = ((function (x39349){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39349))
...
x39349.cljs_node_io$protocols$IOFactory$make_output_stream$arity$2 = ((function (x39349){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39349))
...
var x39350 = streamobj;
x39350.cljs_node_io$protocols$IInputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39350.cljs_node_io$protocols$IOutputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39350.cljs_node_io$protocols$IOFactory$ = cljs.core.PROTOCOL_SENTINEL;

x39350.cljs_node_io$protocols$IOFactory$make_reader$arity$2 = ((function (x39350){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39350))
...
x39350.cljs_node_io$protocols$IOFactory$make_input_stream$arity$2 = ((function (x39350){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39350))
...
x39350.cljs_node_io$protocols$IOFactory$make_writer$arity$2 = ((function (x39350){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39350))
...
x39350.cljs_node_io$protocols$IOFactory$make_output_stream$arity$2 = ((function (x39350){
return (function (this$,_){
var this$__$1 = this;
return this$__$1;
});})(x39350))
...
var x39356 = cljs_node_io.streams.output_IOF_BANG_.call(null,strm);
x39356.toString = ((function (x39356,data,buf,write,strm,_,___$1){
return (function (){
var ___$2 = this;
...
});})(x39356,data,buf,write,strm,_,___$1))
;

x39356.toBuffer = ((function (x39356,data,buf,write,strm,_,___$1){
return (function (){
var ___$2 = this;
...
if((function (){var or__8926__auto__ = ((!((f == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === f.cljs_node_io$protocols$IFile$)))?true:false):false);
if(or__8926__auto__){
...
var flags = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"flags","flags",1775418075));
var encoding = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"encoding","encoding",1728578272));
var fd = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"fd","fd",-1524403000));
var mode = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var autoClose_QMARK_ = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"autoClose?","autoClose?",375814080));
var options = ({"encoding": (function (){var or__8926__auto__ = encoding;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return null;
}
})(), "flags": (function (){var or__8926__auto__ = flags;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return "r";
}
})(), "fd": (function (){var or__8926__auto__ = fd;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return null;
}
})(), "mode": (function (){var or__8926__auto__ = mode;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return (438);
}
})(), "autoClose": (function (){var or__8926__auto__ = autoClose_QMARK_;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return true;
...
var _ = filestreamobj.on("open",((function (map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc){
return (function (fd__$1){
return cljs.core.reset_BANG_.call(null,filedesc,fd__$1);
});})(map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc))
);
var x39362_39363 = filestreamobj;
x39362_39363.cljs_node_io$protocols$IInputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39362_39363.cljs$core$IEquiv$ = cljs.core.PROTOCOL_SENTINEL;

x39362_39363.cljs$core$IEquiv$_equiv$arity$2 = ((function (x39362_39363,map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc,_){
...
});})(x39362_39363,map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc,_))
;

x39362_39363.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x39362_39363.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x39362_39363,map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc,_){
...
x39362_39363.getFd = ((function (x39362_39363,map__39360,map__39360__$1,flags,encoding,fd,mode,autoClose_QMARK_,options,filestreamobj,filedesc,_){
return (function (){
var ___$1 = this;
...
var append = cljs.core.get.call(null,map__39367__$1,new cljs.core.Keyword(null,"append","append",-291298229));
var flags = cljs.core.get.call(null,map__39367__$1,new cljs.core.Keyword(null,"flags","flags",1775418075));
var encoding = cljs.core.get.call(null,map__39367__$1,new cljs.core.Keyword(null,"encoding","encoding",1728578272));
var mode = cljs.core.get.call(null,map__39367__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var fd = cljs.core.get.call(null,map__39367__$1,new cljs.core.Keyword(null,"fd","fd",-1524403000));
var options = ({"defaultEncoding": (function (){var or__8926__auto__ = encoding;
if(cljs.core.truth_(or__8926__auto__)){
return or__8926__auto__;
} else {
return "utf8";
...
var filedesc = cljs.core.atom.call(null,null);
var _ = filestreamobj.on("open",((function (map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc){
return (function (fd__$1){
return cljs.core.reset_BANG_.call(null,filedesc,fd__$1);
});})(map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc))
);
var x39369_39370 = filestreamobj;
x39369_39370.cljs_node_io$protocols$IOutputStream$ = cljs.core.PROTOCOL_SENTINEL;

x39369_39370.cljs$core$IEquiv$ = cljs.core.PROTOCOL_SENTINEL;

x39369_39370.cljs$core$IEquiv$_equiv$arity$2 = ((function (x39369_39370,map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc,_){
return (function (this$,that){
var this$__$1 = this;
return (cljs.core._EQ_.call(null,cljs.core.type.call(null,this$__$1),cljs.core.type.call(null,that))) && (cljs.core._EQ_.call(null,this$__$1.path,that.path));
});})(x39369_39370,map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc,_))
;

x39369_39370.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x39369_39370.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x39369_39370,map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc,_){
return (function (this$,writer,opts__$1){
var this$__$1 = this;
...
x39369_39370.getFd = ((function (x39369_39370,map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc,_){
return (function (){
var ___$1 = this;
return cljs.core.deref.call(null,filedesc);
});})(x39369_39370,map__39367,map__39367__$1,append,flags,encoding,mode,fd,options,filestreamobj,filedesc,_))
