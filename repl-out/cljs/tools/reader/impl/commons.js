...
var G__46932 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46932;
continue;
} else {
return ch;
...
var vec__46933 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__46933,(0),null);
return (match === s);
});
...
var len__22481__auto___46949 = arguments.length;
var i__22482__auto___46950 = (0);
while(true){
if((i__22482__auto___46950 < len__22481__auto___46949)){
args__22488__auto__.push((arguments[i__22482__auto___46950]));

var G__46951 = (i__22482__auto___46950 + (1));
i__22482__auto___46950 = G__46951;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__22489__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46945){
var G__46946 = cljs.core.first.call(null,seq46945);
var seq46945__$1 = cljs.core.next.call(null,seq46945);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__46946,seq46945__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46952__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__46952 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46953__i = 0, G__46953__a = new Array(arguments.length -  1);
while (G__46953__i < G__46953__a.length) {G__46953__a[G__46953__i] = arguments[G__46953__i + 1]; ++G__46953__i;}
  _ = new cljs.core.IndexedSeq(G__46953__a,0,null);
} 
return G__46952__delegate.call(this,rdr,_);};
G__46952.cljs$lang$maxFixedArity = 1;
G__46952.cljs$lang$applyTo = (function (arglist__46954){
var rdr = cljs.core.first(arglist__46954);
var _ = cljs.core.rest(arglist__46954);
return G__46952__delegate(rdr,_);
});
G__46952.cljs$core$IFn$_invoke$arity$variadic = G__46952__delegate;
return G__46952;
})()
;
});
