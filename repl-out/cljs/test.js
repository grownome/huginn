...
var G__51994 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__51994,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__51994;
}
});
...
var or__21202__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__22481__auto___51999 = arguments.length;
var i__22482__auto___52000 = (0);
while(true){
if((i__22482__auto___52000 < len__22481__auto___51999)){
args__22488__auto__.push((arguments[i__22482__auto___52000]));

var G__52001 = (i__22482__auto___52000 + (1));
i__22482__auto___52000 = G__52001;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__22489__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq51996){
var G__51997 = cljs.core.first.call(null,seq51996);
var seq51996__$1 = cljs.core.next.call(null,seq51996);
var G__51998 = cljs.core.first.call(null,seq51996__$1);
var seq51996__$2 = cljs.core.next.call(null,seq51996__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__51997,G__51998,seq51996__$2);
});
...
var file = cljs.core.get.call(null,map__52003__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52003__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52003__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__52003,map__52003__$1,file,line,column){
return (function (p1__52002_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__52002_SHARP_));
});})(map__52003,map__52003__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__22257__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__22257__auto__,prefer_table__22258__auto__,method_cache__22259__auto__,cached_hierarchy__22260__auto__,hierarchy__22261__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__21202__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__21202__auto__)){
return or__21202__auto__;
} else {
...
var temp__5457__auto___52005 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___52005)){
var message_52006 = temp__5457__auto___52005;
cljs.core.println.call(null,message_52006);
} else {
}
...
var temp__5457__auto___52007 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___52007)){
var message_52008 = temp__5457__auto___52007;
cljs.core.println.call(null,message_52008);
} else {
}
...
var output_dir = "repl-out";
var output_dir__$1 = (function (){var G__52009 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52009),"/"].join('');
} else {
return G__52009;
}
})();
...
var temp__5455__auto__ = (function (){var and__21190__auto__ = typeof exception.stack === 'string';
if(and__21190__auto__){
var G__52011 = exception.stack;
var G__52011__$1 = (((G__52011 == null))?null:clojure.string.split_lines.call(null,G__52011));
var G__52011__$2 = (((G__52011__$1 == null))?null:cljs.core.get.call(null,G__52011__$1,depth));
if((G__52011__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__52011__$2);
}
} else {
...
var vec__52012 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__52012,(0),null);
var column = cljs.core.nth.call(null,vec__52012,(1),null);
var vec__52015 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__52015,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__52015,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__52015,(2),null);
...
var m__$1 = (function (){var G__52018 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__52022 = (function (){var G__52021 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__52021);
} else {
return G__52021;
}
})();
...
return cljs.core.vary_meta.call(null,G__52023,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__52027 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__52027,(0),null);
var types = vec__52027;
...
return cljs.core.map.call(null,(function (p__52030){
var vec__52031 = p__52030;
var ns = cljs.core.nth.call(null,vec__52031,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__52031,(1),null);
return ((function (vec__52031,ns,vars__$1){
return (function (){
...
var G__52034 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1){
return (function (){
var seq__52035 = cljs.core.seq.call(null,vars__$1);
var chunk__52036 = null;
var count__52037 = (0);
var i__52038 = (0);
while(true){
if((i__52038 < count__52037)){
var v = cljs.core._nth.call(null,chunk__52036,i__52038);
var temp__5457__auto___52040 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___52040)){
var t_52041 = temp__5457__auto___52040;
each_fixture_fn.call(null,((function (seq__52035,chunk__52036,count__52037,i__52038,t_52041,temp__5457__auto___52040,v,each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52041)));
});})(seq__52035,chunk__52036,count__52037,i__52038,t_52041,temp__5457__auto___52040,v,each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1))
);
} else {
}

var G__52042 = seq__52035;
var G__52043 = chunk__52036;
var G__52044 = count__52037;
var G__52045 = (i__52038 + (1));
seq__52035 = G__52042;
chunk__52036 = G__52043;
count__52037 = G__52044;
i__52038 = G__52045;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__52035);
if(temp__5457__auto__){
var seq__52035__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__52035__$1)){
var c__22133__auto__ = cljs.core.chunk_first.call(null,seq__52035__$1);
var G__52046 = cljs.core.chunk_rest.call(null,seq__52035__$1);
var G__52047 = c__22133__auto__;
var G__52048 = cljs.core.count.call(null,c__22133__auto__);
var G__52049 = (0);
seq__52035 = G__52046;
chunk__52036 = G__52047;
count__52037 = G__52048;
i__52038 = G__52049;
continue;
} else {
var v = cljs.core.first.call(null,seq__52035__$1);
var temp__5457__auto___52050__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___52050__$1)){
var t_52051 = temp__5457__auto___52050__$1;
each_fixture_fn.call(null,((function (seq__52035,chunk__52036,count__52037,i__52038,t_52051,temp__5457__auto___52050__$1,v,seq__52035__$1,temp__5457__auto__,each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52051)));
});})(seq__52035,chunk__52036,count__52037,i__52038,t_52051,temp__5457__auto___52050__$1,v,seq__52035__$1,temp__5457__auto__,each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1))
);
} else {
}

var G__52052 = cljs.core.next.call(null,seq__52035__$1);
var G__52053 = null;
var G__52054 = (0);
var G__52055 = (0);
seq__52035 = G__52052;
chunk__52036 = G__52053;
count__52037 = G__52054;
i__52038 = G__52055;
continue;
}
} else {
...
});})(each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1))
);
});})(each_fixture_fn,G__52034,G__52034__$1,env,once_fixtures,each_fixtures,vec__52031,ns,vars__$1))
], null);
